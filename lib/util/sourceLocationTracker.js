 ...
 *
 * @param {String} address - contract address from which the source location is retrieved
 * @param {Int} pc - PC of current VM step
 * @param {Object} contractDetails - AST of compiled contracts
 * @param {Function} cb - callback function
 */
SourceLocationTracker.prototype.getSourceLocationFromVMTraceIndex =
  function (address, pc, sourceMap, hexCode) {
    let index = this.codeManager.getInstructionIndex(address, pc, hexCode);
