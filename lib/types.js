...
const events = {
  ...
  debugContinueExec: 'Debugger:continueExec',
  debugStart: 'Debugger:start',
  VMBreakpoint: 'VM:breakpoint',
  VMStep: 'VM:step',
  runContract: 'TestRPC:runContract',
  stepInto: 'TestRPC:stepInto',
  stepOver: 'TestRPC:stepOver',
  context: 'TestRPC:context',
  message: 'message',
};
