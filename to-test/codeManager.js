'use strict'
// TODO: Convert to ES6 class/extends
let tape = require('tape');
let Web3Providers = require('../src/web3Provider/web3Providers');
let TraceManager = require('../src/trace/traceManager');
let CodeManager = require('../src/code/codeManager');
let web3Test = require('./resources/testWeb3');
let util = require('../src/helpers/global');
...
tape('CodeManager', function(t) {
  ...
  web3Providers.get('TEST', function (error, obj) {
    if (error) {
      ...
      let contractCode = util.web3.eth.getCode('0x0d3a18d64dfe4f927832ab58d6451cecc4e517c5')
      ...
      let tx = util.web3.eth.getTransaction('0x20ef65b8b186ca942fcccd634f37074dde49b541c27994fc7596740ef44cfd51')
